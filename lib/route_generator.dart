...
import 'package:ecommerce_app_ui_kit/src/screens/Login/LoginScreen.dart';
import 'package:ecommerce_app_ui_kit/src/screens/store.dart';
import 'package:ecommerce_app_ui_kit/src/screens/stores.dart';
import 'package:ecommerce_app_ui_kit/src/screens/cart.dart';
import 'package:ecommerce_app_ui_kit/src/screens/categoriesSideMenu.dart';
...
//        return MaterialPageRoute(builder: (_) => MobileVerification2());
      ...
      case '/Store':
        return MaterialPageRoute(
            builder: (_) => StoreWidget(routeArgument: args as RouteArgument));
      case '/Product':
        return MaterialPageRoute(
            builder: (_) =>
