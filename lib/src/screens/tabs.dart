...
import 'package:ecommerce_app_ui_kit/src/Controller/Init_Controller.dart';
...
//        ),
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      initState: (_) => InitController.to.initializeData(),
      builder: (controller) {
        if (controller.isLoading)
          ...
          return Scaffold(
            ...
            appBar: widget.currentTab != 2 ? normalAppbar() : searchAppBar(),
