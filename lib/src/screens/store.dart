...
import 'package:ecommerce_app_ui_kit/src/widgets/ProductsByStoreWidget.dart';
...
class StoreWidget extends StatefulWidget {
  ...
  StoreWidget({Key key, this.routeArgument}) {
    _store = this.routeArgument.argumentsList[0] as Result;
  }
            ...
            background: Stack(
              children: <Widget>[
                Container(
                  ...
                  child: Center(
                    child: Hero(
                      tag: widget._store.id,
                      child: Text(
                        widget._store.name + ' image',
                        style: Theme.of(context).textTheme.bodyText2,
                        maxLines: 1,
                        softWrap: false,
                        overflow: TextOverflow.fade,
                      )/*(widget._store.image != null) ? SvgPicture.network(
                        widget._store.image,
                        color: Theme.of(context).primaryColor,
                        width: 130,
                      ) : SvgPicture.asset(
        ...
        SliverList(
          delegate: SliverChildListDelegate([
            Offstage(
              ...
              child: Column(
                children: <Widget>[
                  StoreHomeTabWidget(store: widget._store),
                ],
              ),
            ),
            Offstage(
              ...
              child: Column(
                children: <Widget>[ProductsByStoreWidget(store: widget._store)],
              ),
            ),
            Offstage(
