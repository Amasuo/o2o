...
class CategoryWidget extends StatefulWidget {
  ...
  CategoryWidget({Key key, this.routeArgument}) {
    _parentCategory = this.routeArgument.argumentsList[0] as ParentCategory.Result;
  }
...
class _CategoryWidgetState extends State<CategoryWidget>
  ...
  List<Category.Result> _subCategoriesList;

  @override
  void initState() {
    _subCategoriesList = widget._parentCategory.children;
      ...
      body: CustomScrollView(slivers: <Widget>[
        ...
        SliverToBoxAdapter(
          child: ProductsByCategoryWidget(
            subCategory:
            _subCategoriesList.elementAt(widget.routeArgument.id),
          ),
        ),
      ]),
    );
