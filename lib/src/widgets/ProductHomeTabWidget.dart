    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              SizedBox(width: 10),
              (double.parse(widget.product.discountAmount) != 0) ?Text(
                widget.product.getPrice(myPrice: (double.parse(widget.product.price) + double.parse(widget.product.discountAmount)).toString()),
              ...
              Expanded(
                child: Text(
                  '${widget.product.soldCount.toString()} Sales',
        ...
        FlashSalesCarouselWidget(
            heroTag: Text('product_related_products'), productsList: ProductsList.flashSalesList),
      ],
    );
  }
}
