...
class StoreGridWidget extends StatelessWidget {
  const StoreGridWidget({
    Key key,
    @required StoresList storesList,
  })  : _storesList = storesList,
        super(key: key);

  final StoresList _storesList;
  ...
  Widget build(BuildContext context) {
    return StaggeredGridView.countBuilder(
      ...
      itemCount: StoresList.storesList.length,
      itemBuilder: (BuildContext context, int index) {
        Result store = StoresList.storesList.elementAt(index);
        return InkWell(
          onTap: () {
            Navigator.of(context)
                .pushNamed('/Store', arguments: new RouteArgument(id: store.id, argumentsList: [store]));
          },
          child: Stack(
            ...
            children: <Widget>[
              Container(
                ...
                child: Hero(
                  ...
                  ),/*(store.image != null) ? SvgPicture.network(
                    store.image,
